...
using yW8VuASj86ha4hlaUTZ;

namespace tTkANOS1c3vUhsfiTtj;

internal static class F3GMWWSQOH55IrwVEm4
{
	public static readonly Regex K4hSE7usVJ;

	private static readonly Regex o28S2q7DEq;

	public static List<Anosc0S4bHkYsg2h8iC> teSSr7AnNl(string P_0)
	{
		List<Anosc0S4bHkYsg2h8iC> list = new List<Anosc0S4bHkYsg2h8iC>();
		...
		{
			list.Add(new Anosc0S4bHkYsg2h8iC(item.Index, item.Length));
		}
		return list;
	}

	public static bool bcbSJ1pxpn(string P_0, Match P_1, W9DpQgSBDhHwuwkYtki P_2, IList<Anosc0S4bHkYsg2h8iC> P_3)
	{
	...
	private static bool tnNSKM7Uqc(int P_0, int P_1, IList<Anosc0S4bHkYsg2h8iC> P_2)
	{
		...
		int num = P_0 + P_1;
		foreach (Anosc0S4bHkYsg2h8iC item in P_2)
		{

...
namespace dL7TFPsQbAGqPywtHUK;

internal static class yR9thasHZ73xXm8eKwj
{
	...
	public static void nCOs10kYTP()
	{
		lock (C10sMv1U6m)
		{
			if (x0vsLnuHe5 != 1 && x0vsLnuHe5 != 2)
			{
				...
				try
				{
					string text = Path.Combine(W6xTwMLd5RvSHoqDfEV.UserDataDir, "Logs");

...
using z4qcZD3zX6qjVYRL15F;

namespace wPeal63s1El9mxiFsCN;

internal sealed class YS7xFb3LM4W2adGhkTa : UserControl
{
	...
	[CompilerGenerated]
	private RkZt4ZuLjXTP5cAL48p iPJ3xa3Y18;
	...
	public RkZt4ZuLjXTP5cAL48p Target
	{
		[CompilerGenerated]
		get
		{
	...
	public YS7xFb3LM4W2adGhkTa()
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();
		O0p3l4nwwc();
		oyZMiq3dqUyFgRD0XD7.fWnUBnsIYw(HwR37nWbFR);
	}
	...
	private void O0p3l4nwwc()
	{
		...
		wAT3avlLMh = new WebView2
		{
			...
			{
				UserDataFolder = W6xTwMLd5RvSHoqDfEV.mSfs9VWIdb("WebView2", "AgentTaskPane")
			},
			Dock = DockStyle.Fill
		};
	...
	public async Task nb43Nxg93w()
	{
		...
		try
		{
			if (!Mj53mPmCxk())
			{
				if (F2ZFeLcsiLlLr89kqUl.JWucG2ERAH("WebView2", "AgentTaskPane"))
				{
			...
			Hsb3qVN1n2 = RmFJn1BhW81y5YhCApL.mJIBvnaH0F(Target);
			if (Hsb3qVN1n2 != null)
			{
				...
				if (text == null)
				{
					throw new FileNotFoundException("index.html" + W6xTwMLd5RvSHoqDfEV.FrontendAssetsDir);
				}
		...
		{
			yR9thasHZ73xXm8eKwj.ujWsURly3F("[AgentUI] initialization failed", ex);
			F2ZFeLcsiLlLr89kqUl.F9Ycoqv2I8("AI 助手初始化失败，请检查配置、网络环境和日志后重试。" + ex.Message, "AI 助手");
			gdA3P70IOX = false;
		}
		finally
		{
	...
	{
		string frontendAssetsDir = W6xTwMLd5RvSHoqDfEV.FrontendAssetsDir;
	...
	{
		bool isIntranetEnvironment = TLTW0G6ghg2cXG3MkV9.Instance.Nju6iKu8Ci().IsIntranetEnvironment;
		var obj = new
		{
			hostKind = "word",
	...
	private void VGG3pk7osX(object P_0, CoreWebView2WebMessageReceivedEventArgs P_1)
	{
		try
		{
			...
			{
				yR9thasHZ73xXm8eKwj.z7Us3dJ6Cl("[AgentUI] " + text);
			}
		}
		catch (Exception ex)
		{
			yR9thasHZ73xXm8eKwj.z7Us3dJ6Cl("[AgentUI] Failed to read web message: " + ex.Message);
		}
	}

	private void lMB3OQ8Rl8(object P_0, CoreWebView2ProcessFailedEventArgs P_1)
	{
		yR9thasHZ73xXm8eKwj.ujWsURly3F(string.Format("[AgentUI] WebView process failed. Kind={0}; Reason={1}", P_1.ProcessFailedKind, P_1.Reason));
	}
	...
	private void ixs3nlkvjU(object P_0, CoreWebView2NavigationCompletedEventArgs P_1)
	{
		...
		{
			yR9thasHZ73xXm8eKwj.z7Us3dJ6Cl("[AgentUI] Navigation failed. Status=" + P_1.WebErrorStatus);
		}
	}

	private void HwR37nWbFR(RkZt4ZuLjXTP5cAL48p P_0, AgentArtifact P_1)
	{
		...
		{
			yR9thasHZ73xXm8eKwj.z7Us3dJ6Cl("HandleArtifactPublished failed: " + ex.Message);
		}
	}
	...
	private void eY03XNcEyA()
	{
		...
		{
			yR9thasHZ73xXm8eKwj.z7Us3dJ6Cl("PushCurrentHostStatus failed: " + ex.Message);
		}
	}

	private static string CdZ3FO2FEj(RkZt4ZuLjXTP5cAL48p P_0)
	{
		try
		{
			Microsoft.Office.Interop.Word.Application wordApp = eSfxffslhXbaGAjFNv1.WordApp;
	...
	protected override void Dispose(bool P_0)
	{
		if (P_0)
		{
			oyZMiq3dqUyFgRD0XD7.vIPU93N8BE(HwR37nWbFR);
			RmFJn1BhW81y5YhCApL.Kf7BW0nRZX(WindowKey);
			wBw3cW9FKn();

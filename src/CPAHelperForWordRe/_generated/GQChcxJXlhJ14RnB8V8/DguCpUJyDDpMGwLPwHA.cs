...
namespace GQChcxJXlhJ14RnB8V8;

internal sealed class DguCpUJyDDpMGwLPwHA : IHostActionProvider
{
	[CompilerGenerated]
	...
	private readonly RkZt4ZuLjXTP5cAL48p V74JW1QeEM;

	private readonly x2u1CVJLYNVQcUFtkEy eQWJ06Z12e;

	private static readonly IReadOnlyList<HostActionInfo> wgFJkXRbS4;

	public DguCpUJyDDpMGwLPwHA() : this(null)
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();
	}

	public DguCpUJyDDpMGwLPwHA(RkZt4ZuLjXTP5cAL48p P_0)
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();
		V74JW1QeEM = P_0;
		eQWJ06Z12e = new x2u1CVJLYNVQcUFtkEy(P_0);
	}
	...
	private HostContextItem Qt0JFe6yQV()
	{
		...
		{
			yR9thasHZ73xXm8eKwj.z7Us3dJ6Cl("引用当前 Word 选区失败：" + ex.Message);
			throw;
		}
	}

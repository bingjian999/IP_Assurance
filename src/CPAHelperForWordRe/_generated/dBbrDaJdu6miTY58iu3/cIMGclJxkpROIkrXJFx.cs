...
namespace dBbrDaJdu6miTY58iu3;

internal sealed class cIMGclJxkpROIkrXJFx
{
	...
	private sealed class _G_c__DisplayClass6_0
	{
		...
		internal string AT2VTB4UV5B(Microsoft.Office.Interop.Word.Application app)
		{
			...
			try
			{
				...
				document = BZOrlUu1R80X7V7qPHv.zrqujYgRXw(app);
				if (document == null)
				{
	...
	private readonly RkZt4ZuLjXTP5cAL48p G6T3iub9oa;

	private readonly x2u1CVJLYNVQcUFtkEy D8c3HsQYl2;

	public cIMGclJxkpROIkrXJFx() : this(null)
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();
	}

	public cIMGclJxkpROIkrXJFx(RkZt4ZuLjXTP5cAL48p P_0)
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();
		G6T3iub9oa = P_0;
		D8c3HsQYl2 = new x2u1CVJLYNVQcUFtkEy(P_0);
	}
	...
	private static void m3O39L5WZm(Microsoft.Office.Interop.Word.Application P_0, Document P_1)
	{
		...
		if (!BZOrlUu1R80X7V7qPHv.Se3uYFg09e(P_1) || current == null)
		{
			return;
		}
		try
	...
	private static void nsM3uRTY4F(Microsoft.Office.Interop.Word.Application P_0, RP3HO3VDvRbxmE03MaWl P_1)
	{
		...
		try
		{
			Document document = BZOrlUu1R80X7V7qPHv.zrqujYgRXw(P_0, (!string.IsNullOrWhiteSpace(P_1.DocumentFullName)) ? P_1.DocumentFullName : P_1.DocumentName);
			document.Activate();
	...
	private fdJEaP38mFSOHURh7Yw rki3gClQ9S<fdJEaP38mFSOHURh7Yw>(string P_0, Func<Microsoft.Office.Interop.Word.Application, fdJEaP38mFSOHURh7Yw> P_1)
	{
		...
		{
			yR9thasHZ73xXm8eKwj.ujWsURly3F("失败：" + P_0 + "失败：" + ex.Message);
			throw new InvalidOperationException(P_0 + "失败：" + ex.Message, ex);
		}
	}

	static cIMGclJxkpROIkrXJFx()
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();

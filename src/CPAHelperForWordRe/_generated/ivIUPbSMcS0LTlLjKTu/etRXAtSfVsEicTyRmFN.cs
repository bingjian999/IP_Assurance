...
namespace ivIUPbSMcS0LTlLjKTu;

internal sealed class etRXAtSfVsEicTyRmFN
{
	private readonly string bHiSmuFwEd;

	public string DirectoryPath => bHiSmuFwEd;

	public etRXAtSfVsEicTyRmFN(string P_0)
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();
		bHiSmuFwEd = W6xTwMLd5RvSHoqDfEV.mSfs9VWIdb("config", P_0);
	}

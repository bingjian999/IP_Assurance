...
using m9hrSbQh2RFofQeUk2k;
using Microsoft.Web.WebView2.Core;
using Microsoft.Web.WebView2.WinForms;
using ndRERvVtEjasqN2cQqiN;
using Newtonsoft.Json.Linq;
using qDDKriLz2Bft1Ehv17i;
using QSfewmQWcqKuTlxqonR;

namespace N4Dsky1BvEyvphnkqiT;

internal sealed class LjykRE1V7qpHBhtFtJP
{
	[CompilerGenerated]
	private sealed class _G_c__DisplayClass14_0
	{
		...
		public O8bpaTQF6Dpo5IeRuxi QH5dLJJKUU;
		...
		public MlrjLBQvC4HsxmNR64C umNdmxJMDT;
			...
			try
			{
				...
				try
				{
					...
					try
					{
						...
						{
							UserDataFolder = W6xTwMLd5RvSHoqDfEV.mSfs9VWIdb("WebView2", "HtmlVisualRenderer", Process.GetCurrentProcess().Id.ToString())
						};
						...
						CS_8_locals_42.fYAdpk6kMZ.Shown += async delegate
						{
							try
							{
								...
								CS_8_locals_42.Am8dnU3Kek.umNdmxJMDT = new MlrjLBQvC4HsxmNR64C
								{
	...
	private sealed class _G_c__DisplayClass14_1
	{
		...
		internal async void ry4dCGg4Z6(object sender, EventArgs args)
		{
			try
			{
				...
				Am8dnU3Kek.umNdmxJMDT = new MlrjLBQvC4HsxmNR64C
				{
	...
	public MlrjLBQvC4HsxmNR64C vl619tBFs5(O8bpaTQF6Dpo5IeRuxi P_0)
	{
		eBW1ghIdqq(P_0);
		DjW1H937bG.Wait();
		try
	...
	private static MlrjLBQvC4HsxmNR64C H6916YM8wK(O8bpaTQF6Dpo5IeRuxi P_0)
	{
		...
		string path = W6xTwMLd5RvSHoqDfEV.XOes64flqb("AI", "HtmlVisuals");
		string path2 = W6xTwMLd5RvSHoqDfEV.mSfs9VWIdb("Agent", "html-visuals");
			...
			try
			{
				...
				try
				{
					...
					try
					{
						...
						{
							UserDataFolder = W6xTwMLd5RvSHoqDfEV.mSfs9VWIdb("HTML visual rendering timed out after 30 seconds.", "HTML visual rendering failed: ", Process.GetCurrentProcess().Id.ToString())
						};
						...
						CS_8_locals_69.fYAdpk6kMZ.Shown += async delegate
						{
							try
							{
								...
								CS_8_locals_69.Am8dnU3Kek.umNdmxJMDT = new MlrjLBQvC4HsxmNR64C
								{
	...
	private static void eBW1ghIdqq(O8bpaTQF6Dpo5IeRuxi P_0)
	{
		if (P_0 == null)
		{
	...
	private static string UNc18HvUui(O8bpaTQF6Dpo5IeRuxi P_0)
	{
	...
	public LjykRE1V7qpHBhtFtJP()
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();
	}

	static LjykRE1V7qpHBhtFtJP()
	{
		hdFXkSVtKBHNJ9MQ8VcZ.AlBVL0oCCKQ();

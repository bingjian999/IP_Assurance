...
namespace XAB6tiK6MBoHw2qTkMe;

internal static class Lom4Z9K9AffMhMIjl25
{
	...
	public static void dW1KDnLD9h()
	{
		try
		{
			...
			F2ZFeLcsiLlLr89kqUl.Ay3cNuEgJo("没有找到下一个高亮", "IP_Assurance");
		}
		catch (Exception ex)
		{
			F2ZFeLcsiLlLr89kqUl.F9Ycoqv2I8(ex.Message, "IP_Assurance");
	...
	public static void QJhKInF2on()
	{
		...
		if (num2 < 0)
		{
			F2ZFeLcsiLlLr89kqUl.Ay3cNuEgJo("没有找到下一个标题", "IP_Assurance");
			return;
		}
		selection.Start = end;
		selection.End = end;
